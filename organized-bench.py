...
run_benchmark(False, max_size, 1, 'blue', "./build/prefix-scan.run", 5, 1, 4, 4, 32, "Nvidia GTX 4070 - bp & no par")
run_benchmark(False, max_size, 1, 'blue', "./build/prefix-scan.run", 5, 0, 4, 4, 32, "Nvidia GTX 4070 - bp & no par")
#run_benchmark(False, max_size, 0, 'green', "./main-bench-path/prefix-scan.run", 5, 1, 5, 32, "Nvidia GTX 4070 - no bp & par", 4)
#run_benchmark(True, max_size, 0, 'black', "./main-bench-path/blit.run", 5, 1, 3, 32, "Nvidia GTX 4070 - blit", 1)
